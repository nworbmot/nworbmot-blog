...
single product), whereas Fischer Tropsch synthesis produces a wide
selection of hydrocarbons, some of which get wasted or have to be
cracked down to shorter chain lengths. If all the FT products can be
used, FT can be competitive with methanol for producing shipping
fuels, kerosene and HVC (the model results show relatively easy
substitution between FT routes and methanol routes for these products).
...
ethylene and other high value chemicals from methanol.
