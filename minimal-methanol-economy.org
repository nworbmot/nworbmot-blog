...
First Posted: 2025.05.19, [[https://github.com/nworbmot/nworbmot-blog][Last Revised]]: 2026.04.08, Author: [[https://www.nworbmot.org/][Tom Brown]]
...
As the hydrogen bubble deflates, what are the alternatives? We present a "minimal methanol backstop": using methanol as a gap-filler for the few sectors electrification can't reach.
...
The result? A system without hydrogen and methane transport, i.e. relying on methanol for non-electric use cases and confining hydrogen to industrial clusters, is just 20 billion euro per year (2.4% of system costs) more expensive.
